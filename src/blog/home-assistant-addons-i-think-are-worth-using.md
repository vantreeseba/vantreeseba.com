---
title: Home Assistant Addons I think are worth using
description:
date: 2026-08-04
tags:
  - post
...
First, there are so many addons in home assistant.
Many of them can be found on the "add on store" called HACS (home assistant community store).

This expands the capability of home assistant greatly.
...
When I get un-lazy I'll list more here.
